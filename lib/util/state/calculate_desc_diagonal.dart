...
List<int> calculateDescDiagonal(int queen) {
  ...
  /// calculating all fields from this starting point up to the queen.
...
/// smallerFields stores the correct list for any queen right of the main
  ...
  /// To fix any overflow from queens left of the main diagonal, we find where
  ...
  /// calculating all the fields between this end and the queen.
